      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 20),
            const Text('이 사람을 팔로우 하세요'),
            const SizedBox(height: 20),
            const Text('인스타그램 만들기'),
            const SizedBox(height: 20),
            Card(
              elevation: 4.0,
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    const Text('gc.youngsoo@gmail.com',
                      style: TextStyle(
